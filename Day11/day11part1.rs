...
fn process_monkey(monkeys: &mut Vec<Monkey>, monkey_id: usize) {
...
fn process_one_round(monkeys: &mut Vec<Monkey>) {
    for monkey_id in 0..monkeys.len() {
        process_monkey(monkeys, monkey_id);
    }
}
